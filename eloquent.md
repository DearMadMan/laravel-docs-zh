...
Of course, you may also use `count`, `sum`, `max`, and other [aggregate functions](/docs/{{language}}/{{version}}/queries#aggregates) provided by the [query builder](/docs/{{language}}/{{version}}/queries). These methods return the appropriate scalar value instead of a full model instance:
