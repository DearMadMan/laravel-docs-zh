...
Of course if you are using the [Blade templating engine](/docs/{{language}}/{{version}}
-/blade), you may use the `{{ }}` syntax to echo the language line or use the `@lang` directive:
